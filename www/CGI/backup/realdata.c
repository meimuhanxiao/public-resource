...
int cgiMain()
{
	...
	fprintf(cgiOut,"<style> #meteorologicalData{width: 100\%;}");
...
//	uint16_t weater = map_p[72]*256+map_p[71];
	...
	fprintf(cgiOut,"<table style=\"width:100\%\" >");

	int i;
	for(i = 0; i < map_p[13];i++){//几个设备
		if((i % 3) == 0)
			fprintf(cgiOut,"<tr style\"width:100%\">");//新的一行
		fprintf(cgiOut,"<td style=\"width:500px; align:left\">");
		...
		case 0:
			fprintf(cgiOut,"设备所在方向：无 <br><br> </td>");
			break;
		case 1:
			fprintf(cgiOut,"设备所在方向：东 <br><br></td>");
			break;
		case 2:
			fprintf(cgiOut,"设备所在方向：南 <br><br></td>");
			break;
		case 3:
			fprintf(cgiOut,"设备所在方向：西 <br><br></td>");
			break;
		case 4:
			fprintf(cgiOut,"设备所在方向：北 <br><br></td>");
			break;
		}
		switch(dev_type){//最后设备类型图片
		case 0x30:{
					  if(now_state == 1)
						  fprintf(cgiOut,"<td style=\"width:70px;align:top；float:left \" ><img src=\"../dev_ico/监控相机1.png\" ></td>");
					  else 
						  fprintf(cgiOut,"<td style=\"width:70px;align:top；float:left \" ><img src=\"../dev_ico/监控相机2.png\" ></td>");
					  break;
				  }
		case 0x31:{
					  if(now_state == 1)
						  fprintf(cgiOut,"<td style=\"width:70px;align:top；float:left \" ><img src=\"../dev_ico/终端服务器1.png\" ></td>");
					  else 
						  fprintf(cgiOut,"<td style=\"width:70px;align:top；float:left \" ><img src=\"../dev_ico/终端服务器2.png\" ></td>");
					  break;
				  }

		case 0x32:{
					  if(now_state == 1)
						  fprintf(cgiOut,"<td style=\"width:70px;align:top；float:left \" ><img src=\"../dev_ico/补光灯1.png\" ></td>");
					  else 
						  fprintf(cgiOut,"<td style=\"width:70px;align:top；float:left \" ><img src=\"../dev_ico/补光灯2.png\" ></td>");
					  break;
				  }
		case 0x39:{
					  if(now_state == 1)
						  fprintf(cgiOut,"<td style=\"width:70px;align:top；float:left \" ><img src=\"../dev_ico/能见度1.png\" ></td>");
					  else 
						  fprintf(cgiOut,"<td style=\"width:70px;align:top；float:left \" ><img src=\"../dev_ico/能见度2.png\" ></td>");
					  break;
				  }
		case 0x3A:{
					  if(now_state == 1)
						  fprintf(cgiOut,"<td style=\"width:70px;align:top；float:left \" ><img src=\"../dev_ico/路感1.png\" ></td>");
					  else 
						  fprintf(cgiOut,"<td style=\"width:70px;align:top；float:left \" ><img src=\"../dev_ico/路感2.png\" ></td>");
					  break;
				  }
		case 0x3B:{
					  if(now_state == 1)
						  fprintf(cgiOut,"<td style=\"width:70px;align:top；float:left \" ><img src=\"../dev_ico/微型气象站1.png\" ></td>");
					  else 
						  fprintf(cgiOut,"<td style=\"width:70px;align:top；float:left \" ><img src=\"../dev_ico/微型气象站2.png\" ></td>");
					  break;
				  }
		case 0x3C:{
					  if(now_state == 1)
						  fprintf(cgiOut,"<td style=\"width:70px;align:top；float:left \" ><img src=\"../dev_ico/机柜1.png\" ></td>");
					  else 
						  fprintf(cgiOut,"<td style=\"width:70px;align:top；float:left \" ><img src=\"../dev_ico/机柜2.png\" ></td>");
					  break;
				  }
		}
